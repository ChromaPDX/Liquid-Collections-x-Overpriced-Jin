...
const writableStream = fs.createWriteStream("./src/nfts/Carly/output.csv");
...
for (let i = 1; i < total + 1; i++) {
  ...
  fs.copyFileSync(`./src/nfts/Carly/GiftNFTs/${fancyIndex}.jpg`, `./src/nfts/Carly/${fancyIndex}.jpg`);
